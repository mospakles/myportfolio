...
export const experiences: Experience[] = [
  ...
  export const projects: Project[] = [
    {
      id: 1,
      title: 'Digisign',
      description: 'A platform that redefines the standards of document signing, by integrating cutting-edge biometric signing capabilities which ensures the authenticity of the signer',
    ...
    },
    {
      ...
      image: '/bellfield.png',
      liveUrl: 'https://forex-platform-demo.com',
      githubUrl: 'https://github.com/mospakles/forex-platform'
    },
    {
      id: 3,
      title: 'Koppoh',
      description: 'An innovative solutions streamline understanding the unique challenges of African SMEs and Startups,',
      technologies: ['React', 'Next.js', 'Firebase', 'Tailwind CSS', 'WebSockets'],
      image: '/koppoh.png',
    ...
    },
    {
      ...
      image: '/nextaid.png',
      liveUrl: 'https://motunrayo-odusina.com',
      githubUrl: 'https://github.com/mospakles/portfolio'
    },
    {
        id: 5,
        title: 'Tango Brooks',
        description: 'A platform to get real-time tracking, spending control, and guaranteed savings on every purchase',
        technologies: ['Next.js', 'TypeScript', 'Framer Motion', 'Tailwind CSS'],
        image: '/tango.png',
        liveUrl: 'https://motunrayo-odusina.com',
        githubUrl: 'https://github.com/mospakles/portfolio'
  ...
  export const certifications = [
    { id: 1, name: 'Frontend Development Program', issuer: 'AltSchool Africa', date: 'Sep 2023' },
    { id: 2, name: 'Microsoft Certified: Azure Developer Associate', issuer: 'Microsoft', date: 'Dec 2022' },
    { id: 3, name: 'Meta Front-End Developer Professional Certificate', issuer: 'Coursera', date: 'Apr 2022' },
    { id: 4, name: 'Frontend Web Developer Nanodegree', issuer: 'Udacity', date: 'Nov 2021' },
    { id: 5, name: 'Software Engineering Program', issuer: 'ALX', date: 'Mar 2022' }
  ];

  export const education = [
    {
      id: 1,
      degree: "Master of Business Administration (MBA) – Entrepreneurship & Innovation",
